...
*/
func (a *AccountsubaccountApiService) SubAccountRouterGetAllSubAccountIncidents(ctx context.Context, xAccountApiKey string, subAccountId int64) ([]ModelsIncident, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/account/subaccount/{subAccountId}/incident"
	localVarPath = strings.Replace(localVarPath, "{"+"subAccountId"+"}", fmt.Sprintf("%v", subAccountId), -1)
